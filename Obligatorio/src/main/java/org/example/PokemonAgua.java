...
public class PokemonAgua extends Pokemon {
    ...
    public String ataqueEspecial() {
        return  "╔═════════════════════════════════════════════════════════\n" +
                "║ El Pokémon " + COLOR_AZUL + getNombre() + COLOR_RESET + " realiza su ataque especial " + COLOR_AZUL + getAtaqueEspecial() + COLOR_RESET + "!\n" +
                "║ Ha infringido un total de " + COLOR_AZUL + getPoderAgua() + COLOR_RESET + " puntos de daño.\n" +
                "╚═════════════════════════════════════════════════════════\n";
    }
